      ...
      <div className="relative container h-screen flex items-center">
        <div className="max-w-2xl space-y-8 animate-fade-in">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
            Discover the Art of
            <span className="text-primary block mt-2">Traditional Elegance</span>
          </h1>
          <p className="text-xl text-white/90 mb-8">
            Explore our curated collection of handcrafted sarees, where centuries-old artistry meets contemporary fashion. Each piece tells a story of heritage and grace.
          </p>
